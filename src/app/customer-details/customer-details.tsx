                ...
                <IgrTabs className={classes("tabs")}>
                  <IgrTab selected={true} className={classes("tab-item")}>
                    ...
                    <div className={classes("column-layout tab-item-content")}>
                      <IgrGrid data={northwindSwaggerOrderDto} primaryKey="orderId" rowSelection="single" allowFiltering={true} filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid")}>
