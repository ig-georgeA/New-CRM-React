...
export async function putCustomerDto(id: string, data?: CustomerDto): Promise<CustomerDto | undefined> {
  ...
  return await FetchApi.fetchApiResponse<CustomerDto | undefined>(`${API_ENDPOINT}/Customers/${id}`, undefined, 'PUT', body, headers);
}
